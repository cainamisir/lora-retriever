...
OUTPUT_DIR="output/${MODEL_NAME}_single_turn_temp"
...
#python  run/single_turn/inference_api.py \
...
python run/single_turn/stats_report.py\
    ...
    --output "result/${MODEL_NAME}_single_turn.json"
